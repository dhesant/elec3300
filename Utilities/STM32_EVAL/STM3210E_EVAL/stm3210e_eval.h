...
#define RIGHT_BUTTON_CLK            RCC_APB2Periph_GPIOB
#define RIGHT_BUTTON_PIN            GPIO_Pin_12
#define RIGHT_BUTTON_EXTI_LINE      EXTI_Line12
#define RIGHT_BUTTON_PORT_SOURCE    GPIO_PortSourceGPIOB
#define RIGHT_BUTTON_PIN_SOURCE     GPIO_PinSource12
#define RIGHT_BUTTON_IRQn           EXTI15_10_IRQn
/**
 * @brief Joystick Left push-button
 */    
#define LEFT_BUTTON_PORT            GPIOB
#define LEFT_BUTTON_CLK             RCC_APB2Periph_GPIOB
#define LEFT_BUTTON_PIN             GPIO_Pin_13
#define LEFT_BUTTON_EXTI_LINE       EXTI_Line13
#define LEFT_BUTTON_PORT_SOURCE     GPIO_PortSourceGPIOB
#define LEFT_BUTTON_PIN_SOURCE      GPIO_PinSource13
#define LEFT_BUTTON_IRQn            EXTI15_10_IRQn  
/**
 * @brief Joystick Up push-button
 */
#define UP_BUTTON_PORT              GPIOB
#define UP_BUTTON_CLK               RCC_APB2Periph_GPIOB
#define UP_BUTTON_PIN               GPIO_Pin_14
#define UP_BUTTON_EXTI_LINE         EXTI_Line14
#define UP_BUTTON_PORT_SOURCE       GPIO_PortSourceGPIOB
#define UP_BUTTON_PIN_SOURCE        GPIO_PinSource14
#define UP_BUTTON_IRQn              EXTI15_10_IRQn  
/**
 * @brief Joystick Down push-button
 */   
#define DOWN_BUTTON_PORT            GPIOB
#define DOWN_BUTTON_CLK             RCC_APB2Periph_GPIOB
#define DOWN_BUTTON_PIN             GPIO_Pin_15
#define DOWN_BUTTON_EXTI_LINE       EXTI_Line15
#define DOWN_BUTTON_PORT_SOURCE     GPIO_PortSourceGPIOB
#define DOWN_BUTTON_PIN_SOURCE      GPIO_PinSource15
#define DOWN_BUTTON_IRQn            EXTI15_10_IRQn
/**
 * @brief Joystick Sel push-button
 */  
#define SEL_BUTTON_PORT             GPIOB
#define SEL_BUTTON_CLK              RCC_APB2Periph_GPIOB
#define SEL_BUTTON_PIN              GPIO_Pin_11
#define SEL_BUTTON_EXTI_LINE        EXTI_Line11
#define SEL_BUTTON_PORT_SOURCE      GPIO_PortSourceGPIOB
#define SEL_BUTTON_PIN_SOURCE       GPIO_PinSource11
